...
Organize manifestos no diretório `devops-ia-kubernetes/` na raiz do projeto. Cada aplicação tem seu subdiretório e cada recurso Kubernetes fica em seu próprio arquivo — nunca agrupe múltiplos recursos no mesmo arquivo:
