...
Este projeto usa Claude Code com agentes especializados definidos em `.claude/agents/`. Cada agente tem um papel especifico e restricoes claras — o arquiteto nunca escreve codigo, o DevOps Engineer nunca toma decisoes arquiteturais sem um ADR aprovado.
...
### devops-senior-engineer (DevOps Engineer)
